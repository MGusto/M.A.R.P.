...
function updateView() {
    ...
    <div class="headerBox" id="introhead">
        <h2 id="maintitle">M.A.R.P.</h2>
            ...
            <div id="navbar"><button id="introbtn" class="navbtn" onclick="swapView(0)">Intro</button><button id="namegenbtn" class="navbtn" onclick="swapView(1)">Name & Faction<br>Generator</button><button id="hideoutbtn" class="navbtn" onclick="swapView(2)">Hideout Picker</button><button id="aboutbtn" class="navbtn" onclick="swapView(3)">About</button></div>
            <br>
            ${currentView}`;
}
